...
DevOps는 이 장벽을 허뭅니다. 개발자는 운영을 이해해야 하고, 운영팀은 개발을 이해해야 합니다. 더 나아가, **개발자가 직접 배포하고 모니터링하는 것**이 표준이 되었습니다. "You build it, you run it"—Amazon의 CTO Werner Vogels의 유명한 말입니다.
