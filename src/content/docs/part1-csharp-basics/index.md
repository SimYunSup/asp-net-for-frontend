---
title: "Part 1 - C# 기초 - TypeScript 개발자를 위한 새로운 언어"
---
...
### [Chapter 1: TypeScript 개발자를 위한 C# 퀵스타트](./chapter1/index.md)
...
### [Chapter 2: C# 고급 기능과 객체지향 프로그래밍](./chapter2/index.md)
...
- **[Part 2: ASP.NET Core 기초](../part2-aspnetcore-basics/index.md)** - 첫 번째 API 구축
...
준비되셨나요? [Chapter 1: TypeScript 개발자를 위한 C# 퀵스타트](./chapter1/index.md)로 시작하세요!
