...
**[Chapter 4: Minimal APIs - Node.js Express 개발자를 위한 빠른 시작](./chapter4/README.md)** 에서는 배운 것을 모두 활용하면서도 **Express.js처럼 간결하게** API를 작성합니다.
...
마지막 챕터를 시작할 준비가 되셨나요? [Chapter 4로 이동하세요!](./chapter4/README.md)
